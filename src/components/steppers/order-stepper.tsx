export const OrderStepper = () => {
    return <ol className="flex items-center w-full mt-6 pb-6 overflow-x-scroll overflow-y-hidden px-4">
        ...
        <li className="flex min-w-32 relative w-full items-center text-white dark:text-blue-500 after:content-[''] after:w-full after:border-b after:border-orange-500 after:border-4 after:inline-block dark:after:border-blue-800">
