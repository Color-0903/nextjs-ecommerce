                    ...
                    <form className="space-y-4 md:space-y-6 pt-3" action="#">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input type={toggle?.password ? 'text' : 'password'} security="false" name="password" id="password" placeholder="••••••••" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                        ...
                        <div>
                            <label htmlFor="password-confirm" className="block mb-2 text-sm font-medium text-orange-700 dark:text-white">Nhập lại khẩu</label>
                            <div className="relative">
                                <input type={toggle?.confirm ? 'text' : 'password'} security="false" name="password-confirm" id="password-confirm" placeholder="••••••••" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
