...
export const LoginForm = () => {
    ...
    return <Spinner isLoading={isLogin || isAuthMe}>
                        ...
                        <form className="space-y-4 md:space-y-6 pt-3" onSubmit={formik.handleSubmit}>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input onChange={formik.handleChange} value={formik.values.password} type={togglePass ? 'text' : 'password'} security="false" name="password" id="password" placeholder="••••••••" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
