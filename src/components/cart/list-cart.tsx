            ...
            <div className="fixed top-0 p-4 w-full max-w-5xl h-screen mx-auto inset-x-0">
                <div className="flex flex-col h-screen bg-white rounded-lg dark:bg-gray-700 shadow-2xl pb-4">
                    ...
                    <div className="w-full max-w-7xl px-6 md:px-5 lg-6 mx-auto mt-5 pb-5 overflow-y-auto overflow-x-hidden flex-1">
                         <div className="relative rounded-3xl border-2 border-gray-200 p-4  grid-cols-12 mb-8 max-lg:max-w-lg max-lg:mx-auto gap-y-4 ">
                            <div className="flex items-center gap-2 col-span-12 lg:col-span-2 img box">
                                <img src="https://pagedone.io/asset/uploads/1701162826.png" alt="speaker image" className="w-24 h-24 md:w-32 md:h-32 lg:w-[120px] lg:h-[120px] " />
                                <h5 className="font-manrope font-bold text-2xl leading-9 text-gray-900">Round white portable speaker</h5>
                            </div>
                            <div className="col-span-12 lg:col-span-10 detail w-full lg:pl-3">
                                <button className="absolute top-1 right-1 rounded-full group flex items-center justify-center focus-within:outline-red-500">
