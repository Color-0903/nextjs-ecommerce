                                ...
                                !auth ?
                                    ...
                                    <div className="flex items-center lg:order-2">
                                        ...
                                        <div className="relative">
                                            <img id="avatarButton" onClick={() => setShowDropdow(!showDropdow)} data-dropdown-toggle="userDropdown" data-dropdown-placement="bottom-start" className="w-10 h-10 rounded-full cursor-pointer" src={Helper.ViewSource(auth?.asset?.source)} alt=".." />
                                            {
                                                showDropdow &&
