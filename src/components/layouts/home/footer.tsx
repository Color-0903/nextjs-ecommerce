...
export default function HomeFooter() {
    return <footer className="bg-gray-50 shadow dark:bg-gray-900 dark:border-gray-700 border-t-2 mt-7">
        <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8 mt-1">
            ...
            <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/" className="hover:underline text-orange-500">Color</a>. All Rights Reserved.</span>
        </div>
    </footer>
